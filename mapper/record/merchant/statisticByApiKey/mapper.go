...
type merchantStatisticByApiKeyMapper struct {
	MerchantStatisticMethodByApiKeyMapper      MerchantStatisticMethodByApiKeyMapper
	MerchantStatisticAmountByApiKeyMapper      MerchantStatisticAmountByApiKeyMapper
	MerchantStatisticTotalAmountByApiKeyMapper MerchantStatisticTotalAmountByApiKeyMapper
}
